export const SKILL_CATEGORIES = [
  {
    title: "Languages",
    icon: "code",
    skills: ["JavaScript", "Python", "C++", "PHP", "SQL"],
  },
  {
    title: "Frontend",
    icon: "monitor",
...
export const PROJECTS = [
  {
    ...
    category: "Full Stack",
    description:
      "LiteFit is a modern, full-stack MERN e-commerce platform designed for selling men's and women's clothing online. It provides users with a sleek shopping experience, secure payments via Stripe, personalized product recommendations, and a beautiful responsive UI built with React and Tailwind CSS.",
  ...
  },
  {
    ...
    category: "Frontend",
    description:
      "iMusic is a modern and elegant UI design concept that showcases music-related courses in a visually appealing layout. Built with Next.js, TypeScript, Aceternity UI, and ShadCN for a smooth and responsive experience.",
  ...
  },
  {
    ...
    category: "Full Stack",
    description:
      "Stayzio is a modern blog platform that enables users to read, write, and manage blogs effortlessly. It includes an admin panel for content moderation, user management, and blog analytics. The platform focuses on clean UI, performance, and enhance user experience .",
  ...
  },
  {
    ...
    category: "AI",
    description:
      "Careerly is an AI-powered career coaching platform that helps users build resumes, prepare for interviews, generate cover letters, and get real-time career guidance. The platform includes a complete user dashboard with token-based AI usage, subscription plans, Stripe payment integration, support & feedback system, and a powerful admin dashboard for managing users, analytics, subscriptions, notifications, and platform activity.",
    thumbnail: "/careerlyfiles/c1.png",
    images: [
      "/careerlyfiles/c1.png",
      "/careerlyfiles/c12.png",
      ...
      "/careerlyfiles/c15.png",
      "/careerlyfiles/c11.png",
      "/careerlyfiles/c13.png",
      "/careerlyfiles/c14.png",
    ],
    features: [
      "AI-powered industry insights and career guidance",
      "Interactive AI chatbot for personalized career support",
      ...
      "Support and feedback system for users",
      "Admin dashboard with platform analytics and statistics",
      "Admin panel to add, edit, and manage subscription plans",
      "Admin access to user details and account activity",
      "Admin feedback management system",
      "Real-time notifications system for admins",
    ],
    technologies: [
      "Next.js",
      "Inngest",
  ...
  },
  {
    ...
    category: "Full Stack",
    description:
      "Anonify is a modern Next.js-based platform that allows users to receive anonymous feedback securely. Users can sign up with NextAuth credentials, verify their email, and share their unique link to get messages or feedback anonymously from others..",
    images: [
      "/anonify/s1.png",
      "/anonify/s2.png",
      "/anonify/s3.png",
  ...
  },
  {
    ...
    category: "Frontend",
    description:
      "A YouTube-like platform built with the MERN stack. Users can watch videos fetched from a REST API and search for videos by keywords.",
  ...
  },
  {
    ...
    category: "Full Stack",
    description:
      "iChat is a modern real-time chat application built with the MERN stack. It allows users to create accounts, browse and chat instantly with other users, and manage their profile including changing their password. The app ensures data security and provides a smooth messaging experience with Socket.IO.",
  ...
  },
  {
    ...
    category: "PHP",
    description:
      "Quizora is a web-based system built with PHP, MySQL, jQuery, and Bootstrap that allows students to take quizzes and view results, while admins can manage quizzes, courses, and students through an intuitive dashboard.",
  ...
  },
  {
    ...
    category: "PHP",
    description:
      "CheezyBite is a dynamic food ordering website built using PHP, MySQL, and Bootstrap. It allows users to browse food items, view details, and place online orders through an easy-to-use and responsive interface.",
  ...
  },
  {
    ...
    category: "PHP",
    description:
      "A full-stack food ordering platform built with PHP, MySQL, and Bootstrap. Includes both admin and user panels, allowing order management, menu updates, and seamless online ordering experience.",
