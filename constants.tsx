...
export const PROJECTS = [
  {
    ...
    category: "AI",
    description:
      "Careerly is an AI-powered career coach offering smart interview prep, personalized cover letters, resume building & analysis, and real-time job market insights.",
